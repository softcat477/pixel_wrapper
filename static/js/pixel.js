	...
	var PixelWrapper = exports.PixelWrapper = function () {
	    ...
	    _createClass(PixelWrapper, [{
	        ...
	        value: function createTooltip() {
	            ...
	            tooltipText = "While in the Select Region Layer, use the " + "rectangle tool to select the regions of the page that you will classify.<br>" + "Draw the rectangles from top left to bottom right. <br><br>" + "Once you select these regions, select another layer and begin classifying!<br>" + "Keep in mind that classification outside these regions will not be utilized.";
